...
router.post('/step-two', function(req, res, next) {
    ...
    res.render(APP + '/open-account-choose', {
...
router.get('/car', function(req, res, next) {
    ...
    res.render(APP + '/open-account-car', {
              ...
              if(body === false)
              {
                ...
                request.post(process.env.OIDC_CI_BASE_URI + '/v2.0/Users', options, function(err, response, body){
                  ...
                  if(response.statusCode == 201){
                    //success
                    res.render(APP + '/open-account-car-success', {
                       quote: 'car',
                    ...
                    //fail
                    res.render(APP + '/open-account-failed');
                  }
                });
              }
              else{
...
router.get('/home', function(req, res, next) {
    ...
    res.render(APP + '/open-account-home', {
          ...
          bbfn.getUserID(req.session.userEmail, accessToken, function(err,  body){
              if(body === false)
              {
                ...
                request.post(process.env.OIDC_CI_BASE_URI + '/v2.0/Users', options, function(err, response, body){
                  ...
                  if(response.statusCode == 201){
                    //success
                    res.render(APP + '/open-account-home-success', {
                       quote: 'home',
                       formSubmission: JSON.stringify(req.body),
                       profileLink: '/app/profile',
                       message: `A password has been generated for you and sent to the email you provided us.`,
